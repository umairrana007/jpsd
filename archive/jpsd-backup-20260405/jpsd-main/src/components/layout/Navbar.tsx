...
export const Navbar: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      {/* 1) Black Marquee Bar - Hidden on Mobile */}
      <div className={`hidden md:flex w-full bg-black text-white py-1 md:py-1.5 overflow-hidden marquee-container transition-all duration-300 pointer-events-auto items-center ${isScrolled ? 'opacity-0 h-0 !py-0' : 'opacity-100'}`}>
        <div className="animate-slide-infinite gap-8 md:gap-14 text-[10px] md:text-xs tracking-wider font-semibold whitespace-nowrap pl-4 w-full">
          <div className="flex gap-8 md:gap-14">
            <span className="text-gray-300">JPSD Foundation - Serving Humanity</span>
      ...
      {/* 2) Social Media Bar - Hidden on Mobile */}
      <div className={`hidden md:flex w-full bg-[#1ea05f] text-white py-1.5 md:py-2 transition-all duration-300 pointer-events-auto border-b border-[#15804a] ${isScrolled ? 'opacity-0 h-0 !py-0 !border-transparent' : 'opacity-100'}`}>
        <div className="max-w-7xl mx-auto px-4 md:px-8 flex justify-end items-center gap-3 md:gap-5 text-[15px] md:text-lg">
          ...
          <a href="https://www.tiktok.com/@jpsd.official" target="_blank" rel="noopener noreferrer" className="hover:text-gray-300 hover:scale-110 transition-all"><FaTiktok /></a>
          ...
          <a href="https://twitter.com/jpsdofficial" target="_blank" rel="noopener noreferrer" className="hover:text-gray-300 hover:scale-110 transition-all"><FaXTwitter /></a>
      ...
      {/* 3) Global Info Bar - Hidden on Mobile */}
      <div className={`hidden md:block w-full py-1.5 px-4 md:px-8 bg-white/40 backdrop-blur-sm transition-all duration-300 pointer-events-auto shadow-sm ${isScrolled ? 'opacity-0 h-0 !py-0 !overflow-hidden' : 'opacity-100 h-auto'}`}>
