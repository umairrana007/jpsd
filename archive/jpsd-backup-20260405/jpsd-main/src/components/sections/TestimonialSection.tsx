...
const testimonials = [
  {
    ...
    text: 'JPSD has made it incredibly easy to contribute to meaningful causes. I can see exactly where my donations are going and the impact they\'re making. The transparency is remarkable.',
    textUrdu: 'جے پی ایس ڈی نے فلاحی کاموں میں حصہ ڈالنا بہت آسان بنا دیا ہے۔ میرے عطیات کہاں لگ رہے ہیں، اس کی شفافیت قابل ستائش ہے۔',
    rating: 5,
  },
  {
    id: 2,
    ...
    text: 'Volunteering with JPSD has been a life-changing experience. The team is dedicated, and seeing the smiles on people\'s faces during food distribution makes it all worthwhile.',
    textUrdu: 'جے پی ایس ڈی کے ساتھ رضاکارانہ کام کرنا میری زندگی کا بہترین تجربہ رہا ہے۔ مستحقین کے چہروں پر مسکراہٹ دیکھ کر دلی سکون ملتا ہے۔',
    rating: 5,
  },
  {
    id: 3,
    ...
    text: 'As a doctor, I\'m proud to offer my services through JPSD\'s free medical camps. We\'ve helped thousands of people who couldn\'t afford healthcare otherwise.',
    textUrdu: 'بحیثیت ڈاکٹر، جے پی ایس ڈی کے طبی کیمپوں کے ذریعے خدمت کرنا میرے لیے فخر کی بات ہے۔ ہم نے ہزاروں غریب مریضوں کا مفت علاج کیا ہے۔',
    rating: 5,
  },
  {
    id: 4,
    ...
    text: 'The educational support my children received from JPSD changed our family\'s future. Today, both my sons are in university thanks to their scholarship programs.',
    textUrdu: 'جے پی ایس ڈی سے ملنے والی تعلیمی معاونت نے ہمارے خاندان کا مستقبل بدل دیا۔ آج میرے بچے ان کے وظائف کی بدولت یونیورسٹی میں پڑھ رہے ہیں۔',
    rating: 5,
  },
];
