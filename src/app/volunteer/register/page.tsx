                  ...
                  <div className="flex gap-4">
                     ...
                     <div>
                        ...
                        <p className="text-xs font-medium text-slate-400 leading-relaxed mt-2 italic">
                           Your application will undergo a deep-vetting review by Baitussalam HQ. You will receive a secure notification on deployment eligibility within 48 operational hours.
                        </p>
                     </div>
                  </div>
               </div>
