        ...
        <div className="lg:col-span-1 space-y-10">
           <section className="bg-slate-900 p-12 rounded-[4rem] text-white space-y-8 shadow-2xl relative overflow-hidden">
              ...
              <p className="text-slate-400 font-medium text-sm leading-relaxed max-w-sm">
                 Baitussalam’s Shariah-compliant accounting system ensures 100% precision in tax-deductible contribution tracking. All certificates are FBR and IRS aligned under the 501(c)(3) or local welfare mandates.
              </p>
