  ...
  const generatePDF = (donation: Donation) => {
    const docDefinition = {
      content: [
        ...
        { text: 'JPSD is a registered NGO. This document serves as proof of individual contribution.', fontSize: 8, color: 'grey', alignment: 'center', margin: [0, 60, 0, 0] }
      ],
      styles: {
    ...
    pdfMake.createPdf(docDefinition as any).download(`JPSD-Receipt-${donation.id}.pdf`);
  };
