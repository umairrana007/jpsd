          ...
          <div className={`space-y-8 prose prose-lg max-w-none text-slate-600 ${isUrdu ? 'urdu-text leading-loose' : ''}`}>
            <p className="text-xl font-medium text-[#0f172a]">
              {isUrdu 
                ...
                : 'Every single operation at Baitussalam International is conducted under the rigorous supervision of authorized scholars and Shariah experts. Our mission is not just welfare; it is to ensure every penny is accounted for within divine boundaries.'}
            </p>
            ...
            <section className="bg-slate-50 p-8 rounded-[2.5rem] border border-slate-100 relative overflow-hidden group">
              ...
              <p>
                {isUrdu 
                  ...
                  : 'Baitussalam operates a permanent link with the Dar-ul-Ifta. Detailed audit reports for all humanitarian projects are presented to our Shariah Board to verify that donor funds have been utilized in precise alignment with Islamic mandates.'}
              </p>
            </section>
