      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        ...
        <div className={`text-center mb-20 space-y-5 ${isUrdu ? 'urdu-text' : ''}`}>
          ...
          <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.1 }} className="text-lg text-slate-500 max-w-2xl mx-auto">
            {isUrdu ? 'بیت السلام کے تعلیمی منصوبے نئی نسل کی تعمیر میں اہم کردار ادا کر رہے ہیں۔' : 'Baitussalam education projects shaping the future generation with knowledge and values.'}
          </motion.p>
        </div>
